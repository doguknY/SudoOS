...
void bno055_get_Qua_XYZ(float xyzw[4]);
 ...
 * configuration tablolari var burda istenilen modun degeri sirasi ve config
 *registeri alinir. Sonra registera degerin sirasini yazma islemi yapilir Mesala
 *accel icin Bandwith configurasyonunda 250Hz besinci sirada ve registeri
 * ACC_CONFIG configdir. Datasheete uygun sekilde bu modun binary degeri
 *registera yazilir.
 *
 **/
...
enum PowerMode { Normalpwr = 0, Lowpower, Suspendpwr };
